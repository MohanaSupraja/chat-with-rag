...
def truncate_chat_history(history, max_turns=3):
...
def chat(query_input: QueryInput):
    ...
    short_chat_history = truncate_chat_history(chat_history)
    print("User Question:", query_input.question)
    print("Chat History:", short_chat_history)
...
def upload_and_index_document(file: UploadFile = File(...)):
    ...
    print("temp_fle_path:",temp_file_path)
